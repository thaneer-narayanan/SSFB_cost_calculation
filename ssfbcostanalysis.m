function [Final_eta_sys,Final_cost_sep,Final_cost_collector,Final_cost_seals,Final_cost_pump,Final_cost_pcs,Final_cost_hex,Final_cost_transformer,Final_cost_interconnection,Final_number_of_cells,Final_channel_height,Final_ASR,exitflag,T] = ssfbcostanalysis

load ('Catholyte 4p2CB 11MnO2.mat');
load ('Cost components for power_upper');
...
ASR_CT_neg = 0; %assuming zinc is plated on the high surface area CB particles
ASR_CONT_pos = @(channel_height,n) r_cont_pos / (vol_frac_am_pos * a_pos);
ASR_CONT_neg = 0; %assuming zinc is plated on the high surface area CB particles
...
[sol,fval,exitflag,output] = ga(@(x) C_power(x(1),x(2)), 2, [], [], [], [], lb, ub, @(x) nonlinconstr_SSFB(x,pump_power_inHP,pump_power_min_inHP), IntCon);
...
load ('Catholyte 4p2CB 11MnO2.mat');
load ('Cost components for power_mid');
load ('Reciprocating pump parameters');
...
load ('Catholyte 4p2CB 11MnO2.mat');
load ('Cost components for power_lower');
load ('Reciprocating pump parameters');
...
clearvars -except Final_cost_sep Final_cost_collector Final_cost_seals Final_cost_pump Final_cost_pcs Final_cost_hex Final_cost_transformer Final_cost_interconnection Final_number_of_cells Final_channel_height Final_ASR exitflag Final_eta_sys

T = table(Final_channel_height,Final_number_of_cells,Final_ASR,Final_eta_sys,Final_cost_sep,Final_cost_collector,Final_cost_seals,Final_cost_pump,Final_cost_pcs,Final_cost_hex,Final_cost_transformer,Final_cost_interconnection,Final_eta_sys)
